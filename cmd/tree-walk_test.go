...
func TestListDir(t *testing.T) {
	...
	listDir1 := listDirFactory(context.Background(), disk1, nil)
	listDir2 := listDirFactory(context.Background(), disk2, nil)
